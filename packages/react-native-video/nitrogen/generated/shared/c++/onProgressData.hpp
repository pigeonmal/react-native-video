  ...
  struct JSIConverter<margelo::nitro::video::onProgressData> final {
    static inline margelo::nitro::video::onProgressData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::video::onProgressData(
        ...
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "seekableDuration")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::video::onProgressData& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "seekableDuration"), JSIConverter<double>::toJSI(runtime, arg.seekableDuration));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "seekableDuration")))) return false;
      return true;
    }
  };
