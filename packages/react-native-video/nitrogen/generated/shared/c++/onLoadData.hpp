  ...
  struct JSIConverter<margelo::nitro::video::onLoadData> final {
    static inline margelo::nitro::video::onLoadData fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::video::onLoadData(
        ...
        JSIConverter<margelo::nitro::video::AllPlayerTracks>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "allPlayerTracks")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::video::onLoadData& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "allPlayerTracks"), JSIConverter<margelo::nitro::video::AllPlayerTracks>::toJSI(runtime, arg.allPlayerTracks));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::video::AllPlayerTracks>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "allPlayerTracks")))) return false;
      return true;
    }
  };
