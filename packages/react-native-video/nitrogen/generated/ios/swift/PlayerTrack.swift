...
/**
 * Represents an instance of `PlayerTrack`, backed by a C++ struct.
 */
public typealias PlayerTrack = margelo.nitro.video.PlayerTrack

public extension PlayerTrack {
  private typealias bridge = margelo.nitro.video.bridge.swift

  /**
   * Create a new instance of `PlayerTrack`.
   */
