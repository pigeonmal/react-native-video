...
/**
 * Represents an instance of `ExternalAudio`, backed by a C++ struct.
 */
public typealias ExternalAudio = margelo.nitro.video.ExternalAudio

public extension ExternalAudio {
  private typealias bridge = margelo.nitro.video.bridge.swift

  /**
   * Create a new instance of `ExternalAudio`.
   */
  init(uri: String, mimetype: String?, headers: Dictionary<String, String>?) {
