...
namespace margelo::nitro::video {
  ...
  std::optional<std::shared_ptr<HybridVideoPlayerSourceSpec>> JHybridVideoPlayerSpec::getSource() {
    ...
    return __result != nullptr ? std::make_optional(__result->getJHybridVideoPlayerSourceSpec()) : std::nullopt;
  }
  ...
  double JHybridVideoPlayerSpec::getProgressEventInterval() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<double()>("getProgressEventInterval");
    auto __result = method(_javaPart);
    return __result;
  }
  void JHybridVideoPlayerSpec::setProgressEventInterval(double progressEventInterval) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(double /* progressEventInterval */)>("setProgressEventInterval");
    method(_javaPart, progressEventInterval);
  }
  int64_t JHybridVideoPlayerSpec::getSubtitleDelay() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<int64_t()>("getSubtitleDelay");
    auto __result = method(_javaPart);
    return __result;
  }
  void JHybridVideoPlayerSpec::setSubtitleDelay(int64_t subtitleDelay) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(int64_t /* subtitleDelay */)>("setSubtitleDelay");
  ...
  std::optional<PlayerTrack> JHybridVideoPlayerSpec::getSelectedTrack() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JPlayerTrack>()>("getSelectedTrack");
    auto __result = method(_javaPart);
  ...
  std::vector<PlayerTrack> JHybridVideoPlayerSpec::getAvailableTextTracks() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JPlayerTrack>>()>("getAvailableTextTracks");
    auto __result = method(_javaPart);
    return [&](auto&& __input) {
  ...
  AllPlayerTracks JHybridVideoPlayerSpec::getAllPlayerTracks() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JAllPlayerTracks>()>("getAllPlayerTracks");
    auto __result = method(_javaPart);
    return __result->toCpp();
  }
  void JHybridVideoPlayerSpec::selectTrackById(TrackType type, const std::optional<std::string>& id) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JTrackType> /* type */, jni::alias_ref<jni::JString> /* id */)>("selectTrackById");
  ...
  void JHybridVideoPlayerSpec::selectTrackByIndex(TrackType type, std::optional<double> index) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JTrackType> /* type */, jni::alias_ref<jni::JDouble> /* index */)>("selectTrackByIndex");
  ...
  void JHybridVideoPlayerSpec::resetForReuse() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void()>("resetForReuse");
    method(_javaPart);
  }
