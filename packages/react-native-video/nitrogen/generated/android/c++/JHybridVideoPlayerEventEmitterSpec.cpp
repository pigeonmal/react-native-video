...
namespace margelo::nitro::video {
  ...
  ListenerSubscription JHybridVideoPlayerEventEmitterSpec::addOnPlayerErrorListener(const std::function<void(const std::string& /* message */)>& listener) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JListenerSubscription>(jni::alias_ref<JFunc_void_std__string::javaobject> /* listener */)>("addOnPlayerErrorListener_cxx");
