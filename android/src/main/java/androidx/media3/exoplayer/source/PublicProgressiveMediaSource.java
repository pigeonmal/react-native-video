 ...
 */
@UnstableApi
public final class PublicProgressiveMediaSource extends BaseMediaSource
    implements ProgressiveMediaPeriod.Listener {

  /**
   * A listener of {@linkplain PublicProgressiveMediaSource progressive media sources}, which will be
  ...
  /** Factory for {@link PublicProgressiveMediaSource}s. */
  ...
  public static final class Factory implements MediaSourceFactory {
    ...
    /**
     * Creates a new factory for {@link PublicProgressiveMediaSource}s.
     *
    ...
    /**
     * Allows the {@link PublicProgressiveMediaSource} to complete preparation without reading any data.
     *
    ...
    /**
     * Returns a new {@link PublicProgressiveMediaSource} using the current parameters.
     *
     * @param mediaItem The {@link MediaItem}.
     * @return The new {@link PublicProgressiveMediaSource}.
     * @throws NullPointerException if {@link MediaItem#localConfiguration} is {@code null}.
     */
    @Override
    public PublicProgressiveMediaSource createMediaSource(MediaItem mediaItem) {
      checkNotNull(mediaItem.localConfiguration);
      return new PublicProgressiveMediaSource(
          mediaItem,
          dataSourceFactory,
          progressiveMediaExtractorFactory,
  ...
  private PublicProgressiveMediaSource(
      MediaItem mediaItem,
      DataSource.Factory dataSourceFactory,
      ProgressiveMediaExtractor.Factory progressiveMediaExtractorFactory,
